...
import { IStoryConfig } from "narraleaf-react/dist/game/nlcore/elements/story";
...
export class ContextActionsService extends Service<ContextActionServiceContent> {
    ...
    public $setVar(name: string, value: DataType | [evaluator: Evaluator, value: ExpressionNode]) {
        return this.trigger(ContextActionType.SetVariable, { name, value });
    }

    public $declareVariable(name: string, type: VariableType) {
